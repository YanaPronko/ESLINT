...
function getNormalizedCurrentFilePath(currentFilePath) {
  ...
  if (projectFrom) return projectFrom.split(path.sep).join('/');
}
getNormalizedCurrentFilePath("C:\\Users\\username\\Desktop\\myApp\\production-project\\src\\entities\\Article")
